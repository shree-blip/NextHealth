// fix-csv-dates.cjs
// Usage: node fix-csv-dates.cjs <input.csv> <output.csv> <dateColumns>
// Example: node fix-csv-dates.cjs clinics.csv clinics_fixed.csv createdAt,updatedAt
...
if (process.argv.length < 5) {
  console.error('Usage: node fix-csv-dates.cjs <input.csv> <output.csv> <dateColumns>');
  process.exit(1);
}
