...
import NextGenApproach from '@/components/landing/NextGenApproach';
...
export const metadata: Metadata = {
  title: 'Healthcare Marketing Agency in Irving, TX | NextGen Marketing Agency',
  description: 'Top-rated healthcare marketing agency based in Irving, TX. We specialize in local SEO, paid ads, and AI automation for ERs, Urgent Cares, and Wellness clinics across Texas.',
  alternates: {
    canonical: 'https://nextgenmarketing.agency',
  }
};
...
const schema = {
  ...
  "image": "https://nextgenmarketing.agency/logo.png",
  ...
  "url": "https://nextgenmarketing.agency",
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-black text-slate-900 text-center mb-4">Frequently Asked Questions</h2>
          ...
          <FAQ faqs={[
            ...
            {q:'What makes NextGen different from other agencies?',a:'We exclusively serve healthcare practices. Our team understands the unique challenges of medical marketing, from compliance requirements to patient acquisition strategies.'},
          ]} />
        </div>
      </section>
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-black text-slate-900 text-center mb-4">Visit Us</h2>
