...
export default function ServicePageTemplate({
  ...
  return (
    <section className="bg-white">
      {/* Hero Section */}
      <div className="relative py-20 md:py-32 bg-gradient-to-br from-emerald-50 to-blue-50">
      ...
      <div className="py-20 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl font-extrabold text-gray-900">{t('Core Features')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('What makes this service essential for healthcare practices')}</p>
          </motion.div>
      ...
      <div className="py-20 border-b border-gray-200">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-extrabold text-gray-900">{t('Service Breakdown')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('Everything included in our comprehensive service')}</p>
          </motion.div>
      ...
      <div className="py-20 bg-emerald-500 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-extrabold">{t('Key Benefits')}</h2>
          </motion.div>
      ...
      {/* FAQ Section */}
      <div className="py-20 border-t border-gray-200 bg-gray-50">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <motion.div
            initial={{ opacity: 0, y: -20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 className="text-4xl font-extrabold text-gray-900">{t('Frequently Asked Questions')}</h2>
            <p className="mt-4 text-xl text-gray-600">{t('Everything you need to know about this service')}</p>
          </motion.div>
          <motion.div
            initial={{ opacity: 0 }}
            whileInView={{ opacity: 1 }}
      ...
      <div className="py-20 bg-white border-t border-gray-200">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8 text-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-4xl font-extrabold text-gray-900 mb-6">{t('Ready to Transform Your Healthcare Practice?')}</h2>
